...
public:
    ...
    {
        Node* node = xfind(head_, key, this);
    ...
    {
        const Node* x = xfind(&head_, key, this);
    ...
    Skiplist<Key, T, Engine, Compare, Allocator>::const_iterator::operator--()
{
    ...
    const Element* e = static_cast<const Element*>(node);
